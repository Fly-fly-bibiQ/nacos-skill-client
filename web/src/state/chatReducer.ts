...
function upsertToolCall(
  tools: ToolCallView[],
  event: { type: "tool_call"; name: string; args: Record<string, unknown>; id?: string },
...
function applyToolResult(
  tools: ToolCallView[],
  event: { name: string; content: string; success?: boolean },
): ToolCallView[] {
...
function applyThinkingEvent(
  ...
  event: { type: "thinking"; content: string },
): AssistantEntry {
  return {
    ...assistant,
    phase: "thinking",
...
function applyTextEvent(
  assistant: AssistantEntry,
  event: { type: "text"; content: string },
): AssistantEntry {
  return {
    ...assistant,
    phase: "responding",
...
function applyDoneEvent(
  assistant: AssistantEntry,
  event: { type: "done"; response?: string },
): AssistantEntry {
  return {
    ...assistant,
    phase: "done",
